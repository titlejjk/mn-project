...
public class UserController {
    ...
    @ResponseBody
    public byte[] getPostImage(@PathVariable("userProfile") String userProfile) throws IOException {
        String absolutePath = fileLocation + File.separator + userProfile; // fileLocation은 파일 저장 위치
