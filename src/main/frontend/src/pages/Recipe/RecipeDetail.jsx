...
export default function Page() {
  ...
  const getReply = () => {
    axios
      .get("http://localhost:9999/recipe/reply/list?rcpNum=" + rcpNum)
      .then((res) => {
        setReply(res.data);
  ...
  return (
    <main className="recipe_detail_main">
          ...
          <div>
            <div>
              <img
                ...
                width="46"
                height="46"
                src="https://img.icons8.com/ios/50/dog--v1.png"
                alt="dog"
              />
            </div>
            {/* 마리 수 */}
      ...
      <div className="recipe_detail_step">
        ...
        <div className="recipe_detail_step_item">
          ...
          <div className="recipe_detail_step_item_mqtt">
            ...
            <button
              onClick={() => {
                axios
                  .get("http://localhost:9999/temperature/publish")
                  .then((res) => {
                    setTopic(res.data);
                  })
                  .catch((error) => {
        ...
        <div className="recipe_detail_user">
          ...
          <button
            ...
            onClick={() => {
              axios
                .post("http://localhost:9999/follow/toggle", {
      ...
      <div className="recipe_detail_reply">
        ...
        <div className="input">
          <div>
            <img src={"list.userProfile"} alt="user thumb" />
          </div>
          ...
          <button
            onClick={(e) => {
              ...
              axios
                .post("http://localhost:9999/recipe/reply/insert", {
                  userNum,
                  rcpNum,
                  rplContent,
                })
        ...
        <Pagination
          pageCount={Math.ceil(reply.length / replyPerPage)}
